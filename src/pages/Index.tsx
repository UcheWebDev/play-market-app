    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {player.category_blocked && !hasHolding && (
          ...
          >
            <i className="ri-lock-line" style={{ fontSize: 11 }} /> Hold{" "}
            {player.category_blocked_player_symbol} — sell first
          </div>
        )}
      </div>
      <div
            ...
            >
              <div
                style={{
                  ...
                  fontWeight: 900,
                  fontSize: 130,
                  color: `hsla(${(player.id * 47) % 360},60%,60%,0.1)`,
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            >
              ...
              >
                <i
                  className={
                    positive ? "ri-arrow-up-line" : "ri-arrow-down-line"
                  }
                  style={{ fontSize: 12 }}
                />{" "}
