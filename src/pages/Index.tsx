...
const MOCK_PORTFOLIO = [
  ...
  { player_id: 3, player_name: "Cole Palmer", player_symbol: "PALMER", token_amount: 200000000, avg_buy_apt: 12.5, current_price: 15.75 },
];
const MOCK_LEADERBOARD = [
  { rank: 1, username: "chukwuemeka_fx", pnl_apt: 1420.5, pnl_pct: 184.2 },
  { rank: 2, username: "lagos_trader", pnl_apt: 980.2, pnl_pct: 142.7 },
  { rank: 3, username: "abuja_picks", pnl_apt: 740.8, pnl_pct: 98.4 },
  { rank: 4, username: "kano_sportsbet", pnl_apt: 510.0, pnl_pct: 71.2 },
  { rank: 5, username: "ibadan_trader", pnl_apt: 380.4, pnl_pct: 52.8 },
];
...
function MarketTabSkeleton() {
  return (
    <div style={{ height: "100%", overflowY: "auto" }}>
      <div style={{ padding: "18px 18px 0" }}>
        <div style={{ marginBottom: 14 }}>
          <Skel w={90} h={22} r={6} style={{ marginBottom: 8 }} />
          <Skel w={160} h={12} />
        </div>
        <Skel w="100%" h={38} r={10} style={{ marginBottom: 11 }} />
        ...
        <Skel w={80} h={12} r={4} style={{ marginBottom: 9 }} />
      </div>
...
function PortfolioTabSkeleton() {
  return (
    <div style={{ height: "100%", overflowY: "auto", padding: "0 0 100px" }}>
      ...
      >
        <Skel w={140} h={11} r={4} style={{ marginBottom: 8 }} />
        <Skel w={180} h={34} r={6} style={{ marginBottom: 8 }} />
        <Skel w={120} h={12} r={4} style={{ marginBottom: 18 }} />
      ...
      <div style={{ padding: "18px 18px 0" }}>
        <Skel w={70} h={12} r={4} style={{ marginBottom: 10 }} />
...
function LeaderboardSkeleton() {
  return (
    <div style={{ height: "100%", overflowY: "auto", padding: "18px 18px 100px" }}>
      <Skel w={140} h={22} r={6} style={{ marginBottom: 6 }} />
      <Skel w={180} h={12} r={4} style={{ marginBottom: 18 }} />
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            <Skel w={30} h={30} r={8} />
            <Skel w="45%" h={13} r={4} style={{ flex: 1 }} />
...
function FormBadge({ rps }) {
  ...
  return (
    <div style={{
      width: 20, height: 20, borderRadius: 5, background: `${c}18`, border: `1px solid ${c}44`,
      display: "flex", alignItems: "center", justifyContent: "center",
      fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800, fontSize: 10, color: c,
    }}>
      {grade}
    </div>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 14, padding: "13px 14px", display: "flex", alignItems: "center",
        gap: 12, cursor: "pointer", transition: "transform 0.1s ease",
    ...
    >
      {hasHolding && (
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 1.5, background: "linear-gradient(90deg, #00FF87, transparent)" }} />
      )}
      {player.category_blocked && !hasHolding && (
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 1.5, background: "linear-gradient(90deg, #F5C842, transparent)" }} />
      )}
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
        ...
        <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 14, color: "#fff", letterSpacing: "-0.02em" }}>
...
function TradeSheet({ player, holding, balance, onClose, onTrade, onToast }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
      ...
      <div style={{
        position: "relative", zIndex: 1, background: "#111",
        ...
        <div style={{ margin: "16px 18px 0", display: "flex", background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: 3 }}>
          {["buy", "sell"].map((m) => (
            <button key={m} onClick={() => { tgHaptic("impact", "light"); setMode(m); setAmount(""); setError(null); }} style={{
              ...
              background: mode === m ? (m === "buy" ? "#00FF87" : "#FF4444") : "transparent",
              color: mode === m ? (m === "buy" ? "#000" : "#fff") : "rgba(255,255,255,0.35)",
            }}>
              {m === "buy" ? "Buy" : "Sell"}
            </button>
          ))}
        ...
        <div style={{ margin: "10px 18px 0", position: "relative", opacity: buyBlocked ? 0.4 : 1 }}>
          ...
          <input type="number" inputMode="decimal" value={amount} onChange={(e) => !buyBlocked && setAmount(e.target.value)}
            disabled={buyBlocked} placeholder={mode === "buy" ? "0.00" : "0.0000"}
        ...
        <div style={{ margin: "14px 18px 0" }}>
          <button onClick={handleTrade} disabled={!canTrade || busy} style={{
            ...
            background: busy ? "rgba(255,255,255,0.06)" : !canTrade ? "rgba(255,255,255,0.05)" : mode === "buy" ? "#00FF87" : "#FF4444",
            color: busy || !canTrade ? "rgba(255,255,255,0.2)" : mode === "buy" ? "#000" : "#fff",
...
function MarketTab({ players, portfolio, onSelect, loading }) {
  ...
  if (loading) return <MarketTabSkeleton />;
    ...
    <div style={{ height: "100%", overflowY: "auto" }}>
      <div style={{ padding: "18px 18px 0" }}>
        ...
        <div style={{ display: "flex", gap: 7, overflowX: "auto", paddingBottom: 4, marginBottom: 16 }}>
          {leagues.map((l) => (
            <button key={l} onClick={() => { tgHaptic("impact", "light"); setFilter(l); }} style={{
              ...
              fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: 12, cursor: "pointer", whiteSpace: "nowrap",
            }}>
              {l === "all" ? "All Leagues" : l}
            </button>
          ))}
...
function PortfolioTab({ portfolio, players, balance, onSelect, loading }) {
  if (loading) return <PortfolioTabSkeleton />;
